...
Status: implementation approved 2026-09-08. Tickets 001–005 are verified; 006 is in progress.
...
| [006](006-session-recovery.md) | recover sessions without inherited autonomous authority | 002 | in-progress | G6, G13 |
...
The current frontier is **006** (Codex, single implementation writer).
