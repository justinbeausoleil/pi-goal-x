...
Status: implementation approved 2026-09-08. Tickets 001–008 are verified; 009 is in progress.
...
| [009](009-blocker-oracle.md) | retain blocker and Oracle recovery through compaction | 007 | in-progress | G2, G12 |
...
The current frontier is **009** (Codex, single implementation writer).
