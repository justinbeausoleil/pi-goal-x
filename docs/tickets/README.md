...
Status: implementation approved 2026-09-08. Tickets 001–004 are verified; 005 is in progress.
...
| [005](005-guided-scope.md) | confirm drafts and revise scope without losing requirements | 004 | in-progress | G7, G10 |
...
The current frontier is **005** (Codex, single implementation writer).
