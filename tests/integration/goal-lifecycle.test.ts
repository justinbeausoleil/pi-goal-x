...
for (const mode of ["goal", "sisyphus"]) for (const scenario of ["cancel", "branches", "stale", "stale-question", "stale-questionnaire", "selector-stale", "fork", "fork-tweak", "active-refine", "active-cancel", "active-settings", "paused-refine", "blocked-refine", "scope", "scope-tweak", "scope-external", "scope-external-goal-contract", "scope-external-task-contract", "scope-external-task-title", "scope-external-new-task"]) {
